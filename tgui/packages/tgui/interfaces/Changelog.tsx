...
const icons = {
  ...
  sound: { icon: 'tg-sound-plus', color: 'green' },
  ...
  image: { icon: 'tg-image-plus', color: 'green' },
...
const Header = (props: { dropdown: any }, _context) => {
  return (
    <Section>
      <h1>Добро пожаловать на Celadon: Shiptest!</h1>
      <p>
        <b>Cпасибо: </b>
        /tg/station, Shiptest, Whitesands, Baystation 12, GoonStation devs, BeeStation,
      ...
      <p>
        ...
        Вам! За то что играете на Celadon!
      </p>
      <p>
